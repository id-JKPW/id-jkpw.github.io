        ...
        <Grid className="aboutme-grid">
          <Cell col={6}>
            <div className="aboutme-text">
              ...
              <p> My interests is in computer security, but I am also interest in web development. Currently lloking for some casual or part time job the can I can experience both aspects of IT work.</p>
